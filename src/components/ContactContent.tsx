  ...
  return (
      <div className="container mx-auto px-4 py-8 md:py-16">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4">{t("contact.title")}</h1>
          <p className="text-muted-foreground text-sm md:text-lg mb-6 md:mb-10 leading-relaxed">
            {t("contact.subtitle")}
          </p>

          <div className="bg-gradient-to-br from-[#229ED9]/10 to-[#229ED9]/5 border border-[#229ED9]/20 rounded-2xl p-5 md:p-8 mb-6 md:mb-10">
            <div className="flex items-center justify-center gap-3 mb-3 md:mb-4">
              <svg className="h-6 w-6 md:h-8 md:w-8" viewBox="0 0 24 24" fill="#229ED9">
              ...
              <h2 className="text-base md:text-xl font-bold">{t("contact.telegramTitle")}</h2>
            </div>
            ...
            {features.map((f) => (
                <Card key={f.titleKey} className="text-center">
                  <CardContent className="pt-4 md:pt-6 px-3 md:px-4">
                    <div className="inline-flex items-center justify-center w-9 h-9 md:w-10 md:h-10 rounded-lg bg-primary/10 mb-2 md:mb-3">
