    ...
    <DialogPortal>
        ...
        <DialogPrimitive.Content
            ...
            className={cn(
                ...
                // Mobile: bottom sheet
                "bottom-0 left-0 right-0 top-auto max-w-full rounded-t-2xl p-6",
                "translate-x-0 translate-y-0",
                // Desktop: centered modal
                "sm:bottom-auto sm:left-[50%] sm:right-auto sm:top-[50%]",
                "sm:max-w-lg sm:rounded-lg",
                "sm:-translate-x-1/2 sm:-translate-y-1/2",
                // Animations — mobile slides up/down
                "data-[state=open]:animate-in data-[state=closed]:animate-out",
                "data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom",
                // Animations — desktop fades/zooms like original
        ...
        >
            ...
            <div
                className="absolute top-3 left-1/2 -translate-x-1/2 h-1 w-10 rounded-full bg-muted-foreground/30 sm:hidden"/>
