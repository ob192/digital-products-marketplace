  ...
  return (
      <>
        <header className="sticky top-0 z-40 w-full border-b border-border/50 bg-background/80 backdrop-blur-md">
          <nav className="container mx-auto flex h-14 md:h-16 items-center justify-between px-4 gap-2">
            {/* Logo */}
            <Link
                href="/"
                className="flex items-center gap-2 font-bold text-lg md:text-xl hover:opacity-80 transition-opacity shrink-0"
            >
              <ShoppingBag className="h-5 w-5 text-primary" />
              <span className="hidden xs:inline">DigitalHub</span>
            </Link>
          ...
          {isOpen && (
              <div className="md:hidden border-t border-border/50 bg-background/95 backdrop-blur-md">
                <div className="container px-4 py-2 flex flex-col gap-0.5">
                  {navLinks.map((link) => (
                      <Link
                          key={link.href}
                          href={link.href}
                  ...
                  <div className="pt-2 border-t border-border/50 mt-1 flex items-center justify-between px-2 pb-1">
                    <LanguageSwitcher />
                    {user ? (
                        <div className="flex items-center gap-2">
